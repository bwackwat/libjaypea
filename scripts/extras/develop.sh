...
-e scripts/python/watcher.py cpp-source/,scripts/build-library.sh,scripts/build-prefix.sh "scripts/build-library.sh" &

xterm -geometry 100x5 \
-T "watcher building examples" \
-e scripts/python/watcher.py cpp-source/examples/,artifacts/libjaypea.so,artifacts/libjaypeap.so,scripts/build-example.sh "scripts/build-example.sh" &

xterm -geometry 100x5 \
-T "watcher running jph2" \
-e scripts/python/watcher.py binaries/jph2,extras.configuration.json "binaries/jph2 -pd ../affable-escapade" &
