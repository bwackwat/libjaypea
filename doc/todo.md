...
3. EpollServer events! This is a very tricky multithreading problem, but is critical for many system I am hoping for. Basically a broadcasting mechanism to write to all fds connected to a server.
