...
Util::define_argument("tanks_port", &tanks_port, {"-tp"});
Util::define_argument("cache_megabytes", &cache_megabytes,{"-cm"});
Util::define_argument("admin_email", admin_email, {"-ae"});
Util::define_argument("sendgrid_key", sendgrid_key, {"-sk"});
