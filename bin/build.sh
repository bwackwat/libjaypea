...
build "./src/tcp-poll-server.cpp ./src/util.cpp -o ./bin/tcp-poll-server"
...
build "-lssl -lcrypto ./src/modern-web-monad.cpp ./src/util.cpp ./src/simple-tcp-server.cpp ./src/json.cpp -o ./bin/modern-web-monad"
build "./src/ponal-client.cpp ./src/util.cpp ./src/simple-tcp-client.cpp -o ./bin/ponal"
build "./src/ponal-server.cpp ./src/util.cpp ./src/simple-tcp-server.cpp -o ./bin/ponald"
build "./src/read-stdin-tty.cpp ./src/util.cpp -o ./bin/read-stdin-tty"
